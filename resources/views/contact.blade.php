    ...
    <section class="mb-4">
        ...
        <div class="row">
            ...
            <div class="border col-md-9 mb-md-0 mb-5 py-4">
                <form class="p-3" id="contact-form" name="contact-form" action="contact" method="POST">
                    @csrf
                    @if(session('success'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="md-form">
                                ...
                                <textarea type="text" id="message" name="message" rows="2" class="form-control @error('message') is-invalid @enderror md-textarea"></textarea>
                                @error('message')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
